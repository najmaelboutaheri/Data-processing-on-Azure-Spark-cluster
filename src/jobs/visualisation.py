...
#Step 1: Standardize and clean the columns
...
def correct_contry_name(name, threshold=85):
...
def get_continent_name(country_name):
    try: 
      ...
      return pcc.convert_continent_code_to_continent_name(continent_code)
       ...
       return None
correct_country_name_udf= udf(correct_contry_name, StringType())
...
# VISUALISATION 1: Number of visa issued in Japan between 2006 and 2017
df_cont = spark.sql("""
...
# VISUALISATION 2: Top 10 countries with the most issued visa in 2017
...
fig.update_layout(title_text="Top 10 countries with the most issued visa in 2017",
                  xaxis_title='country',
                  yaxis_title='Number of visa issued',
                  legend_title='country')

fig.write_html('output/visa_number_in_japan_country_2017.html')


# VISUALISATION 3: display the output on the map
